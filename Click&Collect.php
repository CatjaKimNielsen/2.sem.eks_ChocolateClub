    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Æske_5stk.png" alt="Fyld selv æske med 5 chokolader">
                <h2 class="overskrift text-center"> Fyld selv æske </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Marcipan.png" alt="Mørk chokolade med marcipan">
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Chokolade_med_Kokos.png" alt="Lys chokolade med kokosfyld">
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Mælkechokolade_med_mandel.png" alt="Mælkechokolade med en hel mandel i midten">
                <h2 class="overskrift text-center"> Lys chokolade </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_MørkChokolade.png" alt="Ren mørk chokolade">
                <h2 class="overskrift text-center"> Mørk chokolade </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Nøddekugle.png" alt="Chokoladekugle med blandet nødder">
                <h2 class="overskrift text-center"> Lys chokolade </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Marcipan_med_Appelsin.png" alt="Hvid chokolade med marcipan og appelsin">
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Chokolade_med_karamel.png" alt="Mørk chokolade med flydende karamel">
                <h2 class="overskrift text-center"> Mørk chokolade </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Nougat_med_Hasselnød.png" alt="Lys chokolade med nougat og hel hasselnød">
                <h2 class="overskrift text-center"> Lys chokolade </h2>
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Skildpadde_med_Mint.png" alt="Mørk chokoladeskildpadde med mint">
            ...
            <div class="col-6 col-md-4 col-xl-3 mb-5">
                <img src="image/Produkt_Mælkechokolade.png" alt="Lys chokoladefrø">
